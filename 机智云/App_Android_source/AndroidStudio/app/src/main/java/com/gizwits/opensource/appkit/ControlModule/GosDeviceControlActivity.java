...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private void initView() {
		...
		sw_bool_nf = (Switch) findViewById(R.id.sw_bool_nf);
	}

	private void initEvent() {

		sw_bool_nf.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_nf:
			sendCommand(KEY_NF, sw_bool_nf.isChecked());
			break;
		default:
			break;
		}
